...
class MainGame():
    ...
    def startgame(self):
        ...
        while True:
            ...
            MainGame.window.blit(self.Text2("user manual"), (900, 5))
            MainGame.window.blit(self.Text2("press up down left right to control badger"), (900, 30))
            MainGame.window.blit(self.Text2("press space to fire"), (900, 50))
            MainGame.window.blit(self.Text2("press esc to revive after death"), (900, 70))
            MainGame.window.blit(self.Text2("do not press other key after your death"), (900, 90))
            self.getevent()
